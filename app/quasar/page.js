...
export default function Page() {
    return (
        <div id={'main-div'} className={'bg-black dark flex flex-col'}>
            ...
            <div id={'news'} className={'w-full min-h-[80vh] bg-black flex flex-col md:flex-row justify-between font-inter text-white'}>
                <div className={'w-full md:w-[60vw] px-4 md:pl-40 pt-10'}>
                    <h1 className={'font-bold text-4xl md:text-8xl'}>News</h1>
                    <p className={'mt-8 md:mt-14 text-lg md:text-2xl/9 text-gray-100'}>
                ...
                <div className={'w-full md:w-1/4 flex flex-col items-center justify-center md:mr-20 mt-8 md:mt-0'}>
            ...
            <div id={'images'} className={'w-full min-h-[80vh] bg-black flex flex-col-reverse md:flex-row justify-between font-inter text-white'}>
                <div className={'w-full md:w-[40vw] flex flex-col items-center justify-center mt-8 md:mt-0'}>
                    <div className={'relative w-full h-64 md:h-[95%]'}>
                        <Image src={'/images/quasar/galaxy-images-mockup.png'} fill alt={'Quasar Images Page'}
                               className={'object-contain'}/>
                    </div>
                </div>
                <div className={'w-full md:w-[60vw] px-4 md:pr-40 pt-10 md:pt-32'}>
                    <h1 className={'font-bold text-4xl md:text-8xl'}>Images</h1>
                    <p className={'mt-8 md:mt-14 text-lg md:text-2xl/9 text-gray-100'}>
            ...
            <div id={'data'} className={'w-full min-h-[80vh] bg-black flex flex-col md:flex-row justify-between font-inter text-white'}>
                <div className={'w-full md:w-[60vw] px-4 md:pl-40 pt-10'}>
                    <h1 className={'font-bold text-4xl md:text-8xl'}>Data</h1>
                    <p className={'mt-8 md:mt-14 text-lg md:text-2xl/9 text-gray-100'}>
            ...
            <div id={'ai'} className={'w-full min-h-[80vh] bg-black flex flex-col-reverse md:flex-row justify-between font-inter text-white'}>
                <div className={'w-full md:w-[40vw] flex flex-col items-center justify-center mt-8 md:mt-0'}>
                    <div className={'relative w-full h-64 md:h-[95%]'}>
                ...
                <div className={'w-full md:w-[60vw] px-4 md:pr-40 pt-10 md:pt-32'}>
                    <ShinyText text={'Quasar AI'} className={'font-bold text-4xl md:text-8xl drop-shadow-[0_0_1px_white]'} speed={3}/>
                    <p className={'mt-8 md:mt-14 text-lg md:text-2xl/9 text-gray-100'}>
            ...
            <div id={'download'} className={'w-full h-auto flex flex-col items-center bg-black text-white font-inter px-4 py-8'}>
                <h1 className={'text-3xl font-semibold mt-8 text-center'}>Download Quasar</h1>
                <div id={'download-buttons'} className={'flex flex-col w-full items-center mt-6 space-y-4'}>
                    <Link href={'https://play.google.com/store/apps/details?id=com.shashankprasanna.quasar'}
                          className={'bg-quasar-dark border border-quasar-dark-border hover:bg-[#161616] py-4 px-6 rounded-full text-white transition-colors duration-300 flex items-center w-full max-w-xs'}>
                        <Image src={'/images/google-play.svg'} width={24} height={24} alt={'Google Play Icon'} />
                        <span className={'ml-2 text-lg font-semibold'}>Get it on Google Play</span>
                    </Link>
                    <div className={'bg-quasar-dark border border-quasar-dark-border py-4 px-6 rounded-full text-gray-500 flex items-center cursor-not-allowed w-full max-w-xs'}>
                        <Image src={'/images/app-store.svg'} width={24} height={24} alt={'App Store Icon'} />
                        <span className={'ml-2 text-lg font-semibold'}>iOS Coming Soon</span>
                    </div>
                </div>
            </div>
            <Footer/>
